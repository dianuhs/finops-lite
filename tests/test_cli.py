...
class TestCostOverview:
    ...
    def test_dry_run_cost_overview_json(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['--dry-run', '--output-format', 'json', 'cost', 'overview'])
        assert result.exit_code == 0
    ...
    def test_dry_run_cost_overview_csv(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['--dry-run', '--output-format', 'csv', 'cost', 'overview'])
        assert result.exit_code == 0
    ...
    def test_dry_run_cost_overview_yaml(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['--dry-run', '--output-format', 'yaml', 'cost', 'overview'])
        assert result.exit_code == 0
    ...
    def test_dry_run_cost_overview_executive(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['--dry-run', '--output-format', 'executive', 'cost', 'overview'])
        assert result.exit_code == 0
...
class TestErrorHandling:
    ...
    def test_invalid_savings_threshold(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['optimize', 'rightsizing', '--savings-threshold', '-10'])
        assert result.exit_code == 1
...
class TestConfiguration:
    ...
    def test_different_group_by(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['--dry-run', 'cost', 'overview', '--group-by', 'ACCOUNT'])
        assert result.exit_code == 0
        assert 'DEMO DATA' in result.output
...
class TestNewFeatures:
    ...
    def test_force_refresh_option(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['--dry-run', 'cost', 'overview', '--force-refresh'])
        assert result.exit_code == 0
        assert 'DEMO DATA' in result.output
    ...
    def test_export_functionality(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['--dry-run', 'cost', 'overview', '--export', 'test_report.json'])
        assert result.exit_code == 0
    ...
    def test_verbose_mode_with_performance(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['--verbose', '--performance', '--dry-run', 'cost', 'overview'])
        assert result.exit_code == 0
        assert 'DEMO DATA' in result.output