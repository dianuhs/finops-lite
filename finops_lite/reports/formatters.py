...
class ReportFormatter:
    ...
    def _format_csv_output(self, cost_data: Dict[str, Any]) -> str:
        ...
        # Demo service data
        services = [
            ['Amazon Elastic Compute Cloud', 1234.56, '43.4%', 41.15, 'up', '15.2%', 163.45],
            ['Amazon Relational Database Service', 543.21, '19.1%', 18.11, 'down', '-8.7%', -51.23],
            ['Amazon Simple Storage Service', 321.45, '11.3%', 10.72, 'stable', '2.1%', 6.78],
